        ...
        const DisorganizationChecklist = () => {
            ...
            return (
                <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-xl border border-stone-100 text-left relative z-10 h-full flex flex-col justify-between">
                    ...
                    <button onClick={() => setShowModal(true)} className="w-full bg-[#D6E31E] text-[#2d2a26] hover:bg-[#7178c8] hover:text-white py-5 rounded-xl font-display font-bold text-xl uppercase tracking-widest transition-all shadow-lg mt-auto">
                        Analyze My Operational Risk
                    </button>

                    {/* MODAL */}
                    {showModal && window.ReactDOM && window.ReactDOM.createPortal(
