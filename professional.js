...
const ProfessionalSpaces = () => {
    ...
    return (
        <div className="bg-brand-base overflow-x-hidden min-h-screen">
            ...
            {/* CONTENT AREA WITH LAYERED TESTIMONIAL CARD */}
            <div className="relative z-20 bg-brand-base">
                ...
                {/* MADISON B TESTIMONIAL - LAYERED HALF-ON / HALF-OFF */}
                <div className="max-w-5xl mx-auto px-4 -mt-48 mb-24 relative">
                    <div className="bg-brand-white rounded-3xl shadow-2xl border border-stone-100 p-12 text-center relative overflow-hidden group hover:scale-[1.02] transition-transform duration-500">
                ...
                <div className="max-w-7xl mx-auto px-4 mb-24 relative z-10 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="relative group rounded-3xl overflow-hidden shadow-lg aspect-[2/3] border border-stone-100 bg-brand-base transition-all hover:shadow-2xl hover:scale-[1.02]">
