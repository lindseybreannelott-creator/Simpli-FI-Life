...
(function() {
    const Residential = () => {
        ...
        // LOCAL ASSETS
        const CheckIcon = () => React.createElement("svg", { className: "w-4 h-4 text-[#2d2a26]", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "4" }, React.createElement("polyline", { points: "20 6 9 17 4 12" }));
        const ArrowIcon = () => React.createElement("svg", { className: "ml-2 w-4 h-4", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2" }, React.createElement("line", { x1: "5", y1: "12", x2: "19", y2: "12" }), React.createElement("polyline", { points: "12 5 19 12 12 19" }));
        const GemIcon = () => React.createElement("svg", { className: "w-8 h-8 text-[#7178c8] animate-spin-top", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2" }, React.createElement("path", { d: "M6 3h12l4 6-10 13L2 9Z" }), React.createElement("path", { d: "M11 3 8 9l4 13 4-13-3-6" }));
        
        const GridBeams = () => React.createElement("div", { className: "absolute inset-0 pointer-events-none opacity-60" }, React.createElement("div", { className: "absolute top-0 left-0 w-full h-full opacity-20 bg-[linear-gradient(to_right,#ffffff_1px,transparent_1px),linear-gradient(to_bottom,#ffffff_1px,transparent_1px)] bg-[size:40px_40px]" }));
