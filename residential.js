...
(function() {
    ...
    const Residential = () => {
        ...
        // 3. Page Title & Scroll
        useEffect(() => {
            if (window.Core && window.Core.usePageTitle) {
                window.Core.usePageTitle("Residential Services");
            }
            window.scrollTo(0, 0);
        }, []);
                    ...
                    <div className={`overflow-hidden transition-all duration-700 ease-in-out ${hasChecks ? 'max-h-[500px] opacity-100 mt-8 pt-8 border-t border-stone-200' : 'max-h-0 opacity-0'}`}>
                        <div className="text-center animate-fade-in-up">
                            ...
                            <Link 
                                to="/booking" 
                                state={getLinkState()}
                                className="inline-flex items-center justify-center px-10 py-4 rounded-full bg-[#D6E31E] text-[#2d2a26] hover:bg-[#7178c8] hover:text-white transition shadow-lg font-display font-bold text-sm uppercase tracking-widest transform hover:-translate-y-1"
                            >
        ...
        return (
            <div className="bg-[#fbf9f7] overflow-x-hidden">
                ...
                <div className="bg-[#d4d7ff] text-[#2d2a26] pt-44 pb-32 px-4 text-center relative overflow-hidden">
                    ...
                    {window.Core && window.Core.GridBeams && <div className="absolute inset-0 pointer-events-none opacity-60"><window.Core.GridBeams beamColor="255, 255, 255" /></div>}
                    ...
                    <div className="relative z-10 max-w-5xl mx-auto">
                        ...
                        <Link 
                            ...
                            className="inline-block bg-[#D6E31E] text-[#2d2a26] px-10 py-4 rounded-full font-bold hover:bg-[#7178c8] hover:text-white transition transform hover:-translate-y-1 font-display uppercase tracking-widest text-sm shadow-xl border border-white/20"
                        >
                ...
                <section id="private-client" className="py-32 bg-[#2d2a26] relative overflow-hidden text-center px-4">
                    ...
                    <div className="max-w-4xl mx-auto relative z-10">
                        ...
                        <Link 
                            ...
                            className="inline-block border border-[#7178c8]/50 text-[#7178c8] hover:text-[#D6E31E] hover:border-[#D6E31E] px-12 py-5 rounded-full font-display font-bold transition-all duration-300 transform hover:-translate-y-1 uppercase tracking-widest text-sm shadow-xl backdrop-blur-sm"
                        >
